...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/l_abani")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/noob_project"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/noob_project"),
        ],
    ]
)
...
image_urls = [
    "https://i.ibb.co/fdfZPpHD/9ffeb9248258.jpg",
    "https://i.ibb.co/fdfZPpHD/9ffeb9248258.jpg",
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [Noob Bots](https://t.me/l_abani)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
